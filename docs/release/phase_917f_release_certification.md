...
**Docs reconciliation HEAD:** `c6f098ce9f011e971705df85eec604ab9834f258`
...
| Local HEAD | `c6f098c…` |
| `origin/main` | `c6f098c…` |
| `release/task0-jam-subscription-expenses` | `c6f098c…` |
...
| # | Item | Status |
|---|------|--------|
| 1–4 | Commit / GitHub / Release / Backend app SHA | docs tip `c6f098c…` · runtime `f85dea6…` |
