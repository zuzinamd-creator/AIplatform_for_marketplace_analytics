...
export function AiTrustPanel(props: {
  ...
  return (
    <div className="rounded-lg border border-amber-900/40 bg-amber-950/20 p-3 text-xs text-slate-300">
      ...
      {trust.confidence_explanation ? (
        <p className="mt-2 text-slate-300">{trust.confidence_explanation}</p>
      ) : null}
