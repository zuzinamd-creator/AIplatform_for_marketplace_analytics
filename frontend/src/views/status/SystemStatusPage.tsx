  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
        <Card className="p-4">
          <div className="text-xs text-slate-400">Обработка загрузок</div>
        ...
        <Card className="p-4">
          <div className="text-xs text-slate-400">Обновление данных</div>
          <div className="mt-2 text-lg font-semibold">
        ...
        <Card className="p-4">
          <div className="text-xs text-slate-400">Готовность AI</div>
      ...
      <Card className="p-5">
        ...
        <div className="mt-3 space-y-2 text-sm text-slate-300">
          <p>
            <span className="font-medium text-slate-200">Загрузка с ошибкой?</span> Проверьте формат файла и выбор
            маркетплейса, затем загрузите повторно. Дубликаты распознаются автоматически.
          </p>
          <p>
            <span className="font-medium text-slate-200">Данные неактуальны?</span> Дождитесь завершения пересборки или
            загрузите более свежие отчёты. При низкой актуальности AI включает “осторожный режим”.
          </p>
          <p>
            <span className="font-medium text-slate-200">AI выглядит ошибочным?</span> Откройте объяснимость, сравните
      ...
      <div className="flex flex-wrap gap-2 text-sm">
        <Link to="/app/reports" className="text-sky-300 hover:underline">
          История отчётов
        </Link>
        <Link to="/app/ai/recommendations" className="text-sky-300 hover:underline">
          Рекомендации
        </Link>
        <Link to="/app/support" className="text-sky-300 hover:underline">
